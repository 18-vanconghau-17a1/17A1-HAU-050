...
with open('C:/Users/ducph/OneDrive/Desktop/New folder (2)/17A1-HAU-050/lab2 (1)/data/efficiency.txt', 'r') as file:
    efficiency = [int(line.strip()) for line in file]

with open('C:/Users/ducph/OneDrive/Desktop/New folder (2)/17A1-HAU-050/lab2 (1)/data/shifts.txt', 'r') as file:
